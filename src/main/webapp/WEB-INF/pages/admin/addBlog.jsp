...
<div class="container">
    ...
    <form:form action="/admin/blogs/addP" method="post" commandName="blog" role="form">
        ...
        <div class="form-group">
            <label for="typeByTypeId.id">Type:</label>
            <select class="form-control" id="typeByTypeId.id" name="typeByTypeId.id">
...
<!-- CKEditor 核心 JavaScript 文件 -->
<script src="//cdn.ckeditor.com/4.4.6/full/ckeditor.js"></script>
<!-- 添加CKEditor标签 -->
<script type="text/JavaScript">
    CKEDITOR.replace('content',
        {
            filebrowserUploadUrl : 'uploadImg',
            language : 'zh-cn',
            image_previewText : ' ',
        });
</script>
